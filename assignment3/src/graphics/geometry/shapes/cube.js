class Cube extends Geometry {
  ...
  generateCubeVertices(x, y) {
      ...
      if (window.rainbow){
        ...
        vertex4.color = [Math.random(),Math.random(), Math.random()];
        vertex5.color = [Math.random(),Math.random(), Math.random()];
        vertex6.color = [Math.random(),Math.random(), Math.random()];
        vertex7.color = [Math.random(),Math.random(), Math.random()];
