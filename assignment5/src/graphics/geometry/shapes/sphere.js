  ...
  generateSphereVertices(segments, x, y, z) {
      ...
      for (var j = 0; j < segments; j++) {
        for (var i = 0; i < segments; i++) {
          ...
          var vertex0 = new Vertex(outerVerts[p1].x + x, outerVerts[p1].y + y, outerVerts[p1].z + z);
          ...
          var vertex1 = new Vertex(outerVerts[p2].x + x, outerVerts[p2].y + y, outerVerts[p2].z + z);
          ...
          var vertex2 = new Vertex(outerVerts[p1 + 1].x + x, outerVerts[p1 + 1].y + y, outerVerts[p1 + 1].z + z);
          ...
          var vertex3 = new Vertex(outerVerts[p1 + 1].x + x, outerVerts[p1 + 1].y + y, outerVerts[p1 + 1].z + z);
          ...
          var vertex4 = new Vertex(outerVerts[p2].x + x, outerVerts[p2].y + y, outerVerts[p2].z + z);
          ...
          var vertex5 = new Vertex(outerVerts[p2 + 1].x + x, outerVerts[p2 + 1].y + y, outerVerts[p2 + 1].z + z);
